...
export default function ContactForm () {
    ...
    return (
        <form className="contact-form-input" onSubmit={ sendEmail }>
            ...
            <div className="form-item">
                ...
                <input input type="email" name="email" value={ values.email } onChange={ handleChange } required />
            ...
            <div className="form-item">
                ...
                <textarea name="message" id="" cols="30" rows="5" value={ values.message } onChange={ handleChange } required />
